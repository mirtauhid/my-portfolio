...
const ContactForm = () => {
    ...
    return (
        <Container fluid className="contacts-form">
            <div className="contact-form-regular">
            ...
            {/* Contact form for media/ for mobile/ for tablet */}

            <div className="contact-form-media">
                <h1  className="contact-title"  style={{ color: '#4B6CC1', textAlign: 'center' }}>Contact Form</h1>
                <br />
                <form method='post' className="main-form" id="mail-form">
                    <Row className="row d-flex justify-content-between mt-50 ">
                        <Col md={6}>
                    ...
                    <Row style={{ padding: '15px', marginTop: '50px' }}>
                        <label className="label-text alignment" for="the-message">MESSAGE</label>
                        <textarea name="message" id="the-message"></textarea>
                    </Row>
                    <Button variant="primary"
                        style={{ marginLeft: '39%', marginTop: '30px' }}
                        className="main-button media-button" type="submit">Submit</Button>
                </form>
            </div>
        </Container>
    );
